 ...
 *
 * @author Rod Johnson
 * @version $Id: DefaultProxyConfig.java,v 1.2 2003/08/21 15:44:31 jhoeller Exp $
 */
public class DefaultProxyConfig implements ProxyConfig {
	...
	/**
	 * Set the attribute registry to use.
	 */
	...
	/**
	 * Return the used attribute registry.
	 */
	...
	/**
	 * @see org.springframework.aop.framework.ProxyConfig#getMethodPointcuts()
	 */
